...
<div class="container-fluid">
    <div class="row h-100">
        ...
        <div class="col-10" id="content">
            ...
            <div class="row">
                <div class="col-4 d-flex justify-content-center align-items-center py-5">
                    <div>
                        <p class="mb-1 text-center fs-1 fw-bold"><?= $nbCategories ?></p>
                        <p class="mb-0 text-center fs-5">catégories</p>
                    </div>
                </div>
                <div class="col-4 py-5 d-flex justify-content-center align-items-center bg-primary-subtle">
                    <div>
                        <p class="mb-1 text-center fs-1 fw-bold"><?= $nbVehicles ?></p>
                        <p class="mb-0 text-center fs-5">véhicules</p>
                    </div>
                </div>
                <div class="col-4 py-5 d-flex justify-content-center align-items-center">
                    <div>
                ...
                <div class="col-4 py-5 d-flex justify-content-center align-items-center bg-success-subtle">
                    <div>
