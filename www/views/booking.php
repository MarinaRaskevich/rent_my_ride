        ...
        <div class="col-12 col-md-6">
            <form method="post">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="lastname" name="lastname" placeholder="ex: Dupont" autocomplete="family-name" pattern="<?= REGEX_NAME ?>" value="<?= $lastname ?? '' ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="firstname" name="firstname" placeholder="ex: Pierre" autocomplete="given-name" pattern="<?= REGEX_NAME ?>" value="<?= $firstname ?? '' ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="email" id="email" name="email" placeholder="ex: example@gmail.com" autocomplete="email" value="<?= $email ?? '' ?>" required>
                ...
                <div class="mb-3">
                    ...
                    <span class="small text-danger"><?= $errors['zipcode'] ?? '' ?></span>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="date" id="startdate" name="startdate" pattern="<?= REGEX_DATE ?>" required>
                </div>

                <div class="mb-3">
                    <label for="enddate" class="form-label mb-1">Date de fin <span class="text-danger">*</span></label>
                    <input class="form-control" type="date" id="enddate" name="enddate" pattern="<?= REGEX_DATE ?>" required>
                </div>
